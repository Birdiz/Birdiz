export default function PageHero({ eyebrow, title, description, badges = [], art }) {
  return (
    <header className="hero-surface mb-5 rounded-[18px] border border-[var(--line-strong)] p-5 md:p-7">
      <div className="grid gap-5 lg:grid-cols-[1.5fr_1fr] lg:items-end">
        <div>
          ...
          <p className="hero-description mt-3 mb-0 max-w-[68ch]">{description}</p>
          {badges.length > 0 ? (
        ...
        <div className="hero-art h-[140px] overflow-hidden rounded-[14px] border border-[var(--line)] bg-[var(--bg-elevated)] p-4 md:h-[170px]">
